        ...
        public void AuditNotice()
        {
            try
            {
                ...
                foreach (var o in list)
                {
                    ...
                    //非营运/警车 类型 载客（小型、微型）
                    if ((o.UseType == (int)RCHL.Model.Enums.UseType.非营运 && o.CarType == (int)RCHL.Model.Enums.CarType.微_小型客车) || (o.UseType == (int)RCHL.Model.Enums.UseType.警车_救护 && o.CarType == (int)RCHL.Model.Enums.CarType.微_小型客车))
                    {
                    ...
                    //运营（教练 客运） 类型 载客
                    if (o.UseType == (int)RCHL.Model.Enums.UseType.营运 && o.CarType == (int)RCHL.Model.Enums.CarType.微_小型客车 || o.UseType == (int)RCHL.Model.Enums.UseType.营运 && o.CarType == (int)RCHL.Model.Enums.CarType.中_大型客车)
                    {
                    ...
                    //非运营/营运 类型 载货
                    if ((o.UseType == (int)RCHL.Model.Enums.UseType.非营运 && o.CarType == (int)RCHL.Model.Enums.CarType.货车1) || (o.UseType == (int)RCHL.Model.Enums.UseType.非营运 && o.CarType == (int)RCHL.Model.Enums.CarType.货车2) || (o.UseType == (int)RCHL.Model.Enums.UseType.非营运 && o.CarType == (int)RCHL.Model.Enums.CarType.低速车) || (o.UseType == (int)RCHL.Model.Enums.UseType.非营运 && o.CarType == (int)RCHL.Model.Enums.CarType.中_大型客车))
                    {
                    ...
                    //营运
                    if ((o.UseType == (int)RCHL.Model.Enums.UseType.营运 && o.CarType == (int)RCHL.Model.Enums.CarType.货车1) || (o.UseType == (int)RCHL.Model.Enums.UseType.营运 && o.CarType == (int)RCHL.Model.Enums.CarType.货车2) || (o.UseType == (int)RCHL.Model.Enums.UseType.营运 && o.CarType == (int)RCHL.Model.Enums.CarType.低速车))
                    {
                    ...
                    //校车 类型 校车
                    if (o.UseType == (int)RCHL.Model.Enums.UseType.校车 && o.CarType == (int)RCHL.Model.Enums.CarType.校车)
                    {
