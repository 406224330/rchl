                    ...
                    studylist.ForEach((o) =>
                    {
                        ...
                        if (o.ServiceDate != null && o.ServiceTime != null)
                        {
                            ...
                            if (DateTime.Now > servicetime.AddDays(day))
                            {
                                ...
                                SendSysMessageBLL.SendMessage(RCHL.Model.Enums.MessageAlterType.学车预约提示, RCHL.Model.Enums.NoticeType.预约提醒, o.MemberId, o.MemberName, _servicetime, "您的学车预约即将到期，请按时进行学车服务", o.StudyOrderNo);
                    ...
                    trainglist.ForEach((o) =>
                    {
                        ...
                        if (o.ServiceDate != null && o.ServiceTime != null)
                        {
                            ...
                            if (DateTime.Now > servicetime.AddDays(day))
                            {
                                //发送消息
                                string _servicetime = string.Format("{0} {1}", DateTime.Parse(o.ServiceDate.ToString()).ToString("yyyy-MM-dd"), o.ServiceTime.TrimEnd(','));
                                SendSysMessageBLL.SendMessage(RCHL.Model.Enums.MessageAlterType.实训预约提示, RCHL.Model.Enums.NoticeType.预约提醒, o.MemberId, o.MemberName, _servicetime, "您的实训预约即将到期，请按时进行实训服务", o.TrainingOrderNo);
                    ...
                    withdrivinglist.ForEach((o) =>
                    {
                        ...
                        if (o.ServiceDate != null && o.ServiceTime != null)
                        {
                            ...
                            if (DateTime.Now > servicetime.AddDays(day))
                            {
                                ...
                                SendSysMessageBLL.SendMessage(RCHL.Model.Enums.MessageAlterType.陪驾预约提示, RCHL.Model.Enums.NoticeType.预约提醒, o.MemberId, o.MemberName, _servicetime, "您的陪驾预约即将到期，请按时进行陪驾服务", o.DrivingOrderNo);
                    ...
                    auditlist.ForEach((o) =>
                    {
                        ...
                        if (o.ServiceDate != null && o.ServiceTime != null)
                        {
                            ...
                            if (DateTime.Now > servicetime.AddDays(day))
                            {
                                //发送消息
                                string _servicetime = string.Format("{0} {1}", DateTime.Parse(o.ServiceDate.ToString()).ToString("yyyy-MM-dd"), o.ServiceTime);
                                SendSysMessageBLL.SendMessage(RCHL.Model.Enums.MessageAlterType.年检预约提示, RCHL.Model.Enums.NoticeType.预约提醒, o.MemberId, o.MemberName, _servicetime, "您的年检预约即将到期，请按时进行年检服务", o.AuditOrderNo);
                    ...
                    auditlist.ForEach((o) =>
                    {
                        ...
                        if (o.ServiceDate != null && o.ServiceTime != null)
                        {
                            ...
                            if (DateTime.Now > servicetime.AddDays(day))
                            {
                                //发送消息
                                string _servicetime = string.Format("{0} {1}", DateTime.Parse(o.ServiceDate.ToString()).ToString("yyyy-MM-dd"), o.ServiceTime);
                                SendSysMessageBLL.SendMessage(RCHL.Model.Enums.MessageAlterType.年检预约提示, RCHL.Model.Enums.NoticeType.预约提醒, o.MemberId, o.MemberName, _servicetime, "您的年检预约即将到期，请按时进行年检服务", o.GroupAuditOrderNo);
                    ...
                    list.ForEach((o) =>
                    {
                        ...
                        if (o.ServiceDate != null && o.ServiceTime != null)
                        {
                            ...
                            if (DateTime.Now > servicetime.AddDays(day))
                            {
                                //发送消息
                                string _servicetime = string.Format("{0} {1}", DateTime.Parse(o.ServiceDate.ToString()).ToString("yyyy-MM-dd"), o.ServiceTime);
                                SendSysMessageBLL.SendMessage(RCHL.Model.Enums.MessageAlterType.代审预约提示, RCHL.Model.Enums.NoticeType.预约提醒, o.MemberId, o.MemberName, _servicetime, "您的代审预约即将到期，请按时进行代审服务", o.TakeAuditOrderNo);
                    ...
                    list.ForEach((o) =>
                    {
                        ...
                        if (o.ServiceDate != null && o.ServiceTime != null)
                        {
                            ...
                            if (DateTime.Now > servicetime.AddDays(day))
                            {
                                //发送消息
                                string _servicetime = string.Format("{0} {1}", DateTime.Parse(o.ServiceDate.ToString()).ToString("yyyy-MM-dd"), o.ServiceTime);
                                SendSysMessageBLL.SendMessage(RCHL.Model.Enums.MessageAlterType.看车预约提示, RCHL.Model.Enums.NoticeType.预约提醒, o.MemberId, o.MemberName, _servicetime, "您的看车预约即将到期，请按时进行看车服务", o.SeeCarOrderNo);
