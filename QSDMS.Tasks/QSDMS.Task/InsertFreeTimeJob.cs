...
namespace QSDMS.Task
{
    ...
    public class InsertFreeTimeJob : IJob
    {
        ...
        public void Execute(IJobExecutionContext context)
        {
            ...
            //驾校教练空闲时间
            var teacherList = TeacherBLL.Instance.GetList(new TeacherEntity() { Status = (int)RCHL.Model.Enums.UseStatus.启用 });
            ...
            var withdrivingteacherList = TeacherBLL.Instance.GetList(new TeacherEntity() { Status = (int)RCHL.Model.Enums.UseStatus.启用, IsWithDriving = 1 });
            ...
            var traingcarList = TrainingCarBLL.Instance.GetList(new TrainingCarEntity() { Status = (int)RCHL.Model.Enums.UseStatus.启用 });
            ...
            var auditList = AuditOrganizationBLL.Instance.GetList(new AuditOrganizationEntity() { Status = (int)RCHL.Model.Enums.UseStatus.启用 });
