                    ...
                    withdrivinglist.ForEach((o) =>
                    {
                        ...
                        if (o.ServiceDate != null && o.ServiceTime != null)
                        {
                            ...
                            if (servicetime < DateTime.Now)
                            {
                                ...
                                SendSysMessageBLL.SendMessage(RCHL.Model.Enums.MessageAlterType.陪驾预约提示, RCHL.Model.Enums.NoticeType.取消提醒, o.MemberId, o.MemberName, _servicetime, "陪驾预约未支付，系统已自动取消,请重新预约", o.DrivingOrderNo);
                    ...
                    withdrivinglist.ForEach((o) =>
                    {
                        ...
                        if (o.ServiceDate != null && o.ServiceTime != null)
                        {
                            ...
                            if (servicetime < DateTime.Now)
                            {
                                ...
                                //发送消息
                                string _servicetime = string.Format("{0} {1}", DateTime.Parse(o.ServiceDate.ToString()).ToString("yyyy-MM-dd"), o.ServiceTime);
                                SendSysMessageBLL.SendMessage(RCHL.Model.Enums.MessageAlterType.陪驾预约提示, RCHL.Model.Enums.NoticeType.完成通知, o.MemberId, o.MemberName, _servicetime, "陪驾预约已完成，祝您生活愉快", o.DrivingOrderNo);
                    ...
                    auditlist.ForEach((o) =>
                    {
                        ...
                        if (o.ServiceDate != null && o.ServiceTime != null)
                        {
                            ...
                            if (servicetime < DateTime.Now)
                            {
                                ...
                                //发送消息
                                string _servicetime = string.Format("{0} {1}", DateTime.Parse(o.ServiceDate.ToString()).ToString("yyyy-MM-dd"), o.ServiceTime);
                                SendSysMessageBLL.SendMessage(RCHL.Model.Enums.MessageAlterType.年检预约提示, RCHL.Model.Enums.NoticeType.取消提醒, o.MemberId, o.MemberName, _servicetime, "年检预约未支付，系统已自动取消,请重新预约", o.AuditOrderNo);
                    ...
                    auditlist.ForEach((o) =>
                    {
                        ...
                        if (o.ServiceDate != null && o.ServiceTime != null)
                        {
                            ...
                            if (servicetime < DateTime.Now)
                            {
                                ...
                                //发送消息
                                string _servicetime = string.Format("{0} {1}", DateTime.Parse(o.ServiceDate.ToString()).ToString("yyyy-MM-dd"), o.ServiceTime);
                                SendSysMessageBLL.SendMessage(RCHL.Model.Enums.MessageAlterType.年检预约提示, RCHL.Model.Enums.NoticeType.完成通知, o.MemberId, o.MemberName, _servicetime, "年检预约已完成，请前往人车APP对本次服务进行评价", o.AuditOrderNo);
                    ...
                    auditlist.ForEach((o) =>
                    {
                        ...
                        if (o.ServiceDate != null && o.ServiceTime != null)
                        {
                            ...
                            if (servicetime < DateTime.Now)
                            {
                                ...
                                //发送消息
                                string _servicetime = string.Format("{0} {1}", DateTime.Parse(o.ServiceDate.ToString()).ToString("yyyy-MM-dd"), o.ServiceTime);
                                SendSysMessageBLL.SendMessage(RCHL.Model.Enums.MessageAlterType.年检预约提示, RCHL.Model.Enums.NoticeType.取消提醒, o.MemberId, o.MemberName, _servicetime, "年检预约未支付，系统已自动取消,请重新预约", o.GroupAuditOrderNo);
                    ...
                    auditlist.ForEach((o) =>
                    {
                        ...
                        if (o.ServiceDate != null && o.ServiceTime != null)
                        {
                            ...
                            if (servicetime < DateTime.Now)
                            {
                                ...
                                //发送消息
                                string _servicetime = string.Format("{0} {1}", DateTime.Parse(o.ServiceDate.ToString()).ToString("yyyy-MM-dd"), o.ServiceTime);
                                SendSysMessageBLL.SendMessage(RCHL.Model.Enums.MessageAlterType.年检预约提示, RCHL.Model.Enums.NoticeType.完成通知, o.MemberId, o.MemberName, _servicetime, "年检预约已完成，请前往人车APP对本次服务进行评价", o.GroupAuditOrderNo);
                    ...
                    list.ForEach((o) =>
                    {
                        ...
                        if (o.ServiceDate != null && o.ServiceTime != null)
                        {
                            ...
                            if (servicetime < DateTime.Now)
                            {
                                ...
                                //发送消息
                                string _servicetime = string.Format("{0} {1}", DateTime.Parse(o.ServiceDate.ToString()).ToString("yyyy-MM-dd"), o.ServiceTime);
                                SendSysMessageBLL.SendMessage(RCHL.Model.Enums.MessageAlterType.看车预约提示, RCHL.Model.Enums.NoticeType.完成通知, o.MemberId, o.MemberName, _servicetime, "看车预约已完成，祝您生活愉快", o.SeeCarOrderNo);
