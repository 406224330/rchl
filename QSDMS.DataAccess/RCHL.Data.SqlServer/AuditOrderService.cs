...
namespace RCHL.Data.SqlServer
{
    ...
    public class AuditOrderService : BaseSqlDataService, IAuditOrderService<AuditOrderEntity, AuditOrderEntity, Pagination>
    {
        ...
        public string GetOrderNo()
        {
            ...
            var count = RCHL_SQLDB.GetInstance().ExecuteScalar<int>("select isnull(max(SUBSTRING(AuditOrderNo,11,len(AuditOrderNo)-10)),0) from tbl_AuditOrder where  Convert(varchar(10), CreateTime,121)=@0", date);
