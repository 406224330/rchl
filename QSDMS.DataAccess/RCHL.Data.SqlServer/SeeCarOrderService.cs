...
namespace RCHL.Data.SqlServer
{
    ...
    public class SeeCarOrderService : BaseSqlDataService, ISeeCarOrderService<SeeCarOrderEntity, SeeCarOrderEntity, Pagination>
    {
        ...
        public string GetOrderNo()
        {
            ...
            var count = RCHL_SQLDB.GetInstance().ExecuteScalar<int>("select isnull(max(SUBSTRING(SeeCarOrderNo,11,len(SeeCarOrderNo)-10)),0) from tbl_SeeCarOrder where  Convert(varchar(10), CreateTime,121)=@0", date);
