...
namespace RCHL.Data.SqlServer
{
    public class GroupAuditOrderService : BaseSqlDataService, IGroupAuditOrderService<GroupAuditOrderEntity, GroupAuditOrderEntity, Pagination>
    {
        ...
        public string GetOrderNo()
        {
            ...
            var count = RCHL_SQLDB.GetInstance().ExecuteScalar<int>("select isnull(max(SUBSTRING(GroupAuditOrderNo,11,len(GroupAuditOrderNo)-10)),0) from tbl_GroupAuditOrder where  Convert(varchar(10), CreateTime,121)=@0", date);
