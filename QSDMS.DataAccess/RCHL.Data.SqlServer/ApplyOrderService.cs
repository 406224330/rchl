...
namespace RCHL.Data.SqlServer
{
    ...
    public class ApplyOrderService :BaseSqlDataService, IApplyOrderService<ApplyOrderEntity, ApplyOrderEntity, Pagination>
    {
        ...
        public string GetOrderNo()
        {
            ...
            var count = RCHL_SQLDB.GetInstance().ExecuteScalar<int>("select isnull(max(SUBSTRING(ApplyOrderNo,11,len(ApplyOrderNo)-10)),0) from tbl_ApplyOrder where  Convert(varchar(10), CreateTime,121)=@0", date);
