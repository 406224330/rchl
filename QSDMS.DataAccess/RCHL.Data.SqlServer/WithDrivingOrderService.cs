...
namespace RCHL.Data.SqlServer
{
    ...
    public class WithDrivingOrderService : BaseSqlDataService, IWithDrivingOrderService<WithDrivingOrderEntity, WithDrivingOrderEntity, Pagination>
    {
        ...
        public string GetOrderNo()
        {
            ...
            var count = RCHL_SQLDB.GetInstance().ExecuteScalar<int>("select isnull(max(SUBSTRING(DrivingOrderNo,11,len(DrivingOrderNo)-10)),0) from tbl_WithDrivingOrder where  Convert(varchar(10), CreateTime,121)=@0", date);
