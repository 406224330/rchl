...
namespace RCHL.Data.SqlServer
{
    ...
    public class TrainingOrderService : BaseSqlDataService, ITrainingOrderService<TrainingOrderEntity, TrainingOrderEntity, Pagination>
    {
        ...
        public string GetOrderNo()
        {
            ...
            var count = RCHL_SQLDB.GetInstance().ExecuteScalar<int>("select isnull(max(SUBSTRING(TrainingOrderNo,11,len(TrainingOrderNo)-10)),0) from tbl_TrainingOrder where  Convert(varchar(10), CreateTime,121)=@0", date);
