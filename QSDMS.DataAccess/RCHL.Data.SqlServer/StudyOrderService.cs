...
namespace RCHL.Data.SqlServer
{
    ...
    public class StudyOrderService : BaseSqlDataService, IStudyOrderService<StudyOrderEntity, StudyOrderEntity, Pagination>
    {
        ...
        public string GetOrderNo()
        {
            ...
            var count = RCHL_SQLDB.GetInstance().ExecuteScalar<int>("select isnull(max(SUBSTRING([StudyOrderNo],11,len([StudyOrderNo])-10)),0) from tbl_StudyOrder where  Convert(varchar(10), CreateTime,121)=@0", date);
