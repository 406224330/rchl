...
namespace RCHL.Data.SqlServer
{
    ...
    public class TakeAuditOrderService : BaseSqlDataService, ITakeAuditOrderService<TakeAuditOrderEntity, TakeAuditOrderEntity, Pagination>
    {
        ...
        public string GetOrderNo()
        {
            ...
            var count = RCHL_SQLDB.GetInstance().ExecuteScalar<int>("select isnull(max(SUBSTRING(TakeAuditOrderNo,11,len(TakeAuditOrderNo)-10)),0) from tbl_TakeAuditOrder where  Convert(varchar(10), CreateTime,121)=@0", date);
