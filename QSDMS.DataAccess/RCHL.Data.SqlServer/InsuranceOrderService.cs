...
namespace RCHL.Data.SqlServer
{
    ...
    public class InsuranceOrderService : BaseSqlDataService, IInsuranceOrderService<InsuranceOrderEntity, InsuranceOrderEntity, Pagination>
    {
        ...
        public string GetOrderNo()
        {
            ...
            var count = RCHL_SQLDB.GetInstance().ExecuteScalar<int>("select isnull(max(SUBSTRING(InsuranceOrderNo,11,len(InsuranceOrderNo)-10)),0) from tbl_InsuranceOrder where  Convert(varchar(10), CreateTime,121)=@0", date);
