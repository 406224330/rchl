...
namespace RCHL.Business
{
    ...
    {
        public static void GivePoint(RCHL.Model.Enums.OperationType type, string accountid, double cosMoney, string orderNo)
        {
            //当前的会员对象
            ...
            if (ruleList != null)
            {
                ...
                if (rule != null)
                {
                    ...
                    {
                        case (int)RCHL.Model.Enums.OperationType.登陆操作:
                            ...
                            var pointlist = PointLogBLL.Instance.GetList(new PointLogEntity() { ObjectId = RCHL.Model.Enums.OperationType.登陆操作.ToString(), MemberId = accountid, StartTime = DateTime.Now.ToString("yyyy-MM-dd") });
                    ...
                    if (flag)
                    {
                        ...
                        entity.Operate = (int)RCHL.Model.Enums.PointOperateType.增加;
