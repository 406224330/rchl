...
namespace RCHL.Business
{
    ...
    public class SendSysMessageBLL
    {
        ...
        public static void SendMessageTeacher(RCHL.Model.Enums.NoticeType notice, string accountid, string servicetime, string content, string orderno)
        {
        ...
        /// <param name="accountid"></param>
        /// <param name="content"></param>
        public static void SendMessage(RCHL.Model.Enums.MessageAlterType type, RCHL.Model.Enums.NoticeType notice, string accountid,string name, string servicetime, string content, string orderno)
        {
            ...
            if (messagesetup.Count > 0)
            {
                ...
                if (accountset.Status == (int)RCHL.Model.Enums.UseStatus.启用)
                {
                    switch (type)
                    {
        ...
        /// <param name="content"></param>
        /// <param name="orderno"></param>
        public static void SendStudyNotice(RCHL.Model.Enums.NoticeType notice, string toUser, string username, string servcicetime, string content, string orderno)
        {
            switch (notice)
            {
                case Enums.NoticeType.预约提醒:
        ...
        /// <param name="content"></param>
        /// <param name="orderno"></param>
        public static void SendTrainingNotice(RCHL.Model.Enums.NoticeType notice, string toUser, string username, string servcicetime, string content, string orderno)
        {
            switch (notice)
            {
                case Enums.NoticeType.预约提醒:
        ...
        /// <param name="content"></param>
        /// <param name="orderno"></param>
        public static void SendSeeCarNotice(RCHL.Model.Enums.NoticeType notice, string toUser, string username, string servcicetime, string content, string orderno)
        {
            switch (notice)
            {
                case Enums.NoticeType.预约提醒:
        ...
        public static void SendAuditNotice(RCHL.Model.Enums.NoticeType notice, string toUser, string username, string servcicetime, string content, string orderno)
        {
            switch (notice)
            {
                case Enums.NoticeType.预约提醒:
        ...
        public static void SendTakeAuditNotice(RCHL.Model.Enums.NoticeType notice, string toUser, string username, string servcicetime, string content, string orderno)
        {
            switch (notice)
            {
                case Enums.NoticeType.预约提醒:
        ...
        public static void SendWithDrivingNotice(RCHL.Model.Enums.NoticeType notice, string toUser, string username, string servcicetime, string content, string orderno)
        {
            switch (notice)
            {
                case Enums.NoticeType.预约提醒:
        ...
        public static void SendInsuranceNotice(RCHL.Model.Enums.NoticeType notice, string toUser, string username, string servcicetime, string content, string orderno)
        {
            switch (notice)
            {
                case Enums.NoticeType.预约提醒:
