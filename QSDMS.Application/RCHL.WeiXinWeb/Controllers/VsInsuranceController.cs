        ...
        public JsonResult CreateOrder(string data)
        {
            ...
            try
            {
                lock (objLock)
                {
                    ...
                    SendSysMessageBLL.SendMessage(RCHL.Model.Enums.MessageAlterType.保险预约提示, RCHL.Model.Enums.NoticeType.预约提醒, LoginUser.UserId, order.MemberName, servicetime, "预约保险", order.InsuranceOrderNo);
