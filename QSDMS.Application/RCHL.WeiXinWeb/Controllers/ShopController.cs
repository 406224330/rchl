                    ...
                    pageList.ForEach((page) =>
                    {
                        if (page.ShopId != null)
                        {
                            ...
                            if (page.ShopCarList != null)
                            {
                                ...
                                {
                                    switch ((RCHL.Model.Enums.CarPriceRange)int.Parse(para.PriceRange))
                                    {
        ...
        public JsonResult CreateOrder(string data)
        {
            ...
            try
            {
                lock (objLock)
                {
                    ...
                    SendSysMessageBLL.SendMessage(RCHL.Model.Enums.MessageAlterType.看车预约提示, RCHL.Model.Enums.NoticeType.预约提醒, LoginUser.UserId, order.MemberName, servicetime, content, order.SeeCarOrderNo);
