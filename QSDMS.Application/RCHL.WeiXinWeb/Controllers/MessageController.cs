    ...
    public class MessageController : BaseController
    {
        ...
        public JsonResult GetMessageAlterType()
        {
            ...
            try
            {
                ...
                string[] names = System.Enum.GetNames(typeof(RCHL.Model.Enums.MessageAlterType));
                int[] values = (int[])System.Enum.GetValues(typeof(RCHL.Model.Enums.MessageAlterType));
