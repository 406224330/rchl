            ...
            try
            {
                ...
                if (list != null)
                {
                    foreach (var item in list)
                    {
                        ...
                        {
                            case (int)RCHL.Model.Enums.AuditType.个人年检:
                                item.SubricTypeName = RCHL.Model.Enums.AuditType.个人年检.ToString();
                                break;
                            case (int)RCHL.Model.Enums.AuditType.集团年检:
                                item.SubricTypeName = RCHL.Model.Enums.AuditType.集团年检.ToString();
                                break;
                            case (int)RCHL.Model.Enums.AuditType.代检:
                                item.SubricTypeName = RCHL.Model.Enums.AuditType.代检.ToString();
                                break;
                            default:
                                break;
                        }
