        ...
        public ActionResult GetPageListJson(Pagination pagination, string queryJson)
        {
            ...
            if (pageList != null)
            {
                pageList.ForEach((o) =>
                {
                    ...
                    if (o.UserType != null)
                    {
                        o.UserTypeName = ((RCHL.Model.Enums.TrainingUserType)o.UserType).ToString();
                    }
            ...
            try
            {
                ...
                if (keys != null)
                {
                    ...
                    foreach (var key in keys)
                    {
                        ...
                        if (entity != null && (entity.Status != (int)RCHL.Model.Enums.TrainingStatus.待支付 && entity.Status != (int)RCHL.Model.Enums.TrainingStatus.待审核 && entity.Status != (int)RCHL.Model.Enums.TrainingStatus.已取消))
                        {
                            flag = false;
