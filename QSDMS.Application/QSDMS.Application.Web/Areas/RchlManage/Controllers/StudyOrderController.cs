    ...
    public class StudyOrderController : BaseController
    {
        ...
        public ActionResult GetPageListJson(Pagination pagination, string queryJson)
        {
            ...
            if (pageList != null)
            {
                pageList.ForEach((o) =>
                {
                    ...
                    if (o.StudyType != null)
                    {
                        o.StudyTypeName = ((RCHL.Model.Enums.StudyType)o.StudyType).ToString();
                    }
                    ...
                    detail.ForEach((d) =>
                   {
                       if (d.TimeType != null)
                       {
                           d.TimeTypeName = ((RCHL.Model.Enums.WorkTimeType)d.TimeType).ToString();
                       }
        ...
        public ActionResult GetDetailListJson(string studyOrderId)
        {
            ...
            list.ForEach((o) =>
            {
                if (o.TimeType != null)
                {
                    o.TimeTypeName = ((RCHL.Model.Enums.WorkTimeType)o.TimeType).ToString();
                }
            });
            ...
            try
            {
                ...
                if (keys != null)
                {
                    ...
                    foreach (var key in keys)
                    {
                        ...
                        if (entity != null && (entity.Status != (int)RCHL.Model.Enums.StudySubscribeStatus.预约成功 && entity.Status != (int)RCHL.Model.Enums.StudySubscribeStatus.取消))
                        {
                            flag = false;
        ...
        public ActionResult SaveForm(string keyValue, string issend, string json)
        {
            try
            {
                ...
                else
                {
                    ...
                    order.Status = (int)RCHL.Model.Enums.StudySubscribeStatus.预约成功;
        ...
        public ActionResult Cancel(string keyValue)
        {
            try
            {
                ...
                if (keys != null)
                {
                    ...
                    {
                        var entity = StudyOrderBLL.Instance.GetEntity(key);
                        if (entity != null && entity.Status != (int)RCHL.Model.Enums.StudySubscribeStatus.预约成功)
                        {
                            flag = false;
