...
namespace QSDMS.Application.Web.Areas.RchlManage.Controllers
{
    ...
    {
        //
        // GET: /RchlManage/GroupAuditOrder/
            ...
            try
            {
                ...
                if (entity != null)
                {
                    ...
                    if (entity.Status == (int)RCHL.Model.Enums.PaySatus.待支付)
                    {
                        ...
                        //送积分
                        GivePointBLL.GivePoint(RCHL.Model.Enums.OperationType.预约年检缴费, entity.MemberId, double.Parse(entity.Price.ToString()), entity.GroupAuditOrderNo);
                        //插入财务表
