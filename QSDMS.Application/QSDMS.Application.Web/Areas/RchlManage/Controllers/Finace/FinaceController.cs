...
namespace QSDMS.Application.Web.Areas.RchlManage.Controllers
{
    public class FinaceController : BaseController
    {
        ...
        public ActionResult GetPageListJson(Pagination pagination, string queryJson)
        {
            ...
            if (pageList != null)
            {
                pageList.ForEach((o) =>
                {
                    ...
                    {
                        o.SourceTypeName = ((RCHL.Model.Enums.FinaceSourceType)o.SourceType).ToString();
                    }
                    if (o.PayType != null)
                    {
                        o.PayTypeName = ((RCHL.Model.Enums.PayType)o.PayType).ToString();
                    }
                    if (o.Status != null)
                    {
        ...
        public ActionResult GetDayListJson(string day)
        {
            ...
            list.ForEach((o) =>
            {
                if (o.Operate == (int)RCHL.Model.Enums.FinaceOperateType.增加)
                {
                    totalInCosMoney += o.CosMoney ?? 0;
                    inCount++;
                }
                if (o.Operate == (int)RCHL.Model.Enums.FinaceOperateType.减少)
                {
        ...
        public ActionResult GetDetailJson(string type, string date)
        {
            ...
            var JsonData = new
            {
                ...
                currentInList = currentInList == null ? null : currentInList.GroupBy(t => t.SourceType)
                        ...
                        {
                            Name = ((RCHL.Model.Enums.FinaceSourceType)g.Key).ToString(),
