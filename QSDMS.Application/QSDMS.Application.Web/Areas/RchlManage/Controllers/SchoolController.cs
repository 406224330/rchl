    ...
    public class SchoolController : BaseController
    {
        ...
        public ActionResult GetPageListJson(Pagination pagination, string queryJson)
        {
            ...
            if (pageList != null)
            {
                pageList.ForEach((o) =>
                {
                    ...
                    o.TeacherCount = TeacherBLL.Instance.GetList(new TeacherEntity() { SchoolId = o.SchoolId }).Count();
                    o.StudentCount = MemberBLL.Instance.GetList(new MemberEntity() { SchoolId = o.SchoolId }).Count();
                    o.ApplyOrderCount = ApplyOrderBLL.Instance.GetList(new ApplyOrderEntity() { SchoolId = o.SchoolId }).Count();
                });
            }
            var JsonData = new
            {
                        ...
                        if (SchoolBLL.Instance.Add(entity))
                        {
                            if (entity.SubjectList != null)
                            {
                                ...
                                foreach (var subjectItem in entity.SubjectList)
                                {
                                    ...
                                    subject.MakeMoney = subjectItem.MakeMoney;
                            ...
                            if (entity.AttachmentPicList != null)
                            {
                                ...
                                foreach (var picitem in entity.AttachmentPicList)
                                {
                                    if (picitem != null)
                                    {
                                        ...
                                        pic.Type = (int)RCHL.Model.Enums.AttachmentPicType.驾校;
        ...
        public ActionResult Disabled(string keyValue)
        {
            try
            {
                ...
                if (entity != null)
                {
                    entity.Status = (int)RCHL.Model.Enums.UseStatus.启用;
        ...
        public ActionResult Enabled(string keyValue)
        {
            try
            {
                ...
                if (entity != null)
                {
                    entity.Status = (int)RCHL.Model.Enums.UseStatus.禁用;
                    SchoolBLL.Instance.Update(entity);
                }
                return Success("操作成功");
            }
        ...
        public void ExportExcel(string queryJson)
        {
            ...
            try
            {
                ...
                if (list != null)
                {
                    ...
                    excelconfig.ColumnEntity.Add(new ColumnEntity() { Column = "Name", ExcelColumn = "驾校名称", Width = 20 });
                    ...
                    excelconfig.ColumnEntity.Add(new ColumnEntity() { Column = "SubjectName", ExcelColumn = "课程", Width = 15 });
                    excelconfig.ColumnEntity.Add(new ColumnEntity() { Column = "StudyPrice", ExcelColumn = "学车费用", Width = 15 });
                    excelconfig.ColumnEntity.Add(new ColumnEntity() { Column = "TeacherCount", ExcelColumn = "教练数", Width = 20 });
                    excelconfig.ColumnEntity.Add(new ColumnEntity() { Column = "StudentCount", ExcelColumn = "学员数", Width = 20 });
                    excelconfig.ColumnEntity.Add(new ColumnEntity() { Column = "ApplyOrderCount", ExcelColumn = "报名订单", Width = 20 });
                    ...
                    foreach (System.Data.DataRow row in data.Rows)
                    {
                        try
                        {
                            if (row[0].ToString() != "")
                            {
                                ...
                                if (row[7].ToString() != "")
                                {
                                    entity.StudyPrice = decimal.Parse(row[7].ToString());
                                }

                                entity.CreateTime = DateTime.Now;
                                entity.CreateId = LoginUser.UserId;
                                entity.IsTraining = 0;//驾校
