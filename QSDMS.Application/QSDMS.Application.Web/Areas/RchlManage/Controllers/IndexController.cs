...
namespace QSDMS.Application.Web.Areas.RchlManage.Controllers
{
    public class IndexController : BaseController
    {
        ...
        public ActionResult GetHomeJson()
        {
            ...
            para.Status = (int)RCHL.Model.Enums.ApplyStatus.待支付;
            data.ApplyOrderList = ApplyOrderBLL.Instance.GetPageList(para, ref pager);
            data.TrainingOrderList = TrainingOrderBLL.Instance.GetPageList(new TrainingOrderEntity() { Status = (int)RCHL.Model.Enums.TrainingStatus.待审核 },ref pager);
