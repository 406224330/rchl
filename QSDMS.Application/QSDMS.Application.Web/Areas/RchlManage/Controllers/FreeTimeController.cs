                    ...
                    if (count > 0)//update
                    {
                        ...
                        foreach (FreeDateEntity freedateItem in list)
                        {
                            ...
                            if (freetimeList != null)
                            {
                                ...
                                {
                                    if (freetimeItem.FreeStatus == (int)RCHL.Model.Enums.FreeTimeStatus.空闲)
                                    {
                            ...
                            if (freedateItem.FreeTimeList != null)
                            {
                                ...
                                {
                                    if (freetimeItem.FreeStatus != (int)RCHL.Model.Enums.FreeTimeStatus.已预约)
                                    {
